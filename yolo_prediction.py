...
def overlap_masks(tensor,size1):
    ...
    # Check if tensor has 10 grayscale images
    # assert tensor.shape[0] == 10, "Tensor should contain 10 images"
    print(size1)
...
# Example usage:
# Assuming `bw_tensor` is a tensor of shape [10, 640, 640]
# overlap_masks(bw_tensor)
